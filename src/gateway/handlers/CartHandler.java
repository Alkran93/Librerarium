...
public class CartHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) {
        try {
            LoggerUtil.log("Received request to /cart: " + exchange.getRequestMethod());

            URL url = new URL(Config.CART_SERVICE_URL + "/cart");
            ...
            LoggerUtil.log("Forwarded to cart service. Response code: " + responseCode);
            ...
            LoggerUtil.log("Error handling /cart: " + e.getMessage());
            sendJsonError(exchange, 503, "Cart service is unavailable.");
        }
    }
